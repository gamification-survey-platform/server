# Generated by Django 3.2 on 2023-04-02 11:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gamification_mode', models.BooleanField(default=True, null=True, blank = True, help_text="If user turns on gamification mode", verbose_name = 'gamification mode'))
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.AddField(
            model_name='reward',
            name='reward_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gamification.rewardtype'),
        ),
        migrations.CreateModel(
            name='Registration',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('curved_score', models.IntegerField(blank=True, null=True)),
                ('grade_title', models.CharField(blank=True, max_length=255, null=True)),
