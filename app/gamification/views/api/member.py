...
class MemberList(generics.RetrieveUpdateDestroyAPIView):
            ...
            members.append(
                {
                    ...
                    "is_staff": registration.user.is_staff,
                    "team": team,
    ...
    def post(self, request, course_id, *args, **kwargs):
        ...
        # For welcome course "1000", directly enroll the user without additional checks
        if course_id == "1000":
            new_user, _ = CustomUser.objects.get_or_create(andrew_id=andrew_id)
            course, _ = Course.objects.get_or_create(id="1000")
        ...
        if course_id != "1000" and not user.is_staff:
