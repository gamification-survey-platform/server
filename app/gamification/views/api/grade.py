...
class GradeList(generics.ListCreateAPIView):
    ...
    @swagger_auto_schema(
        operation_description="Get grade information",
        tags=['grades']
    )
    ...
    def post(self, request, course_id, assignment_id, *args, **kwargs):
        ...
        if 'artifact_id' in request.data:
            ...
            if userRole == Registration.UserRole.Instructor:
                ...
                try:
                    ...
                    grade = Grade.objects.create(
                        artifact=artifact, score=score, grade_title=grade_title)
            ...
            artifacts_id_and_scores_dict = request.data.get(
