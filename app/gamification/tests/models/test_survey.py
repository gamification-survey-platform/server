...
from app.gamification.models import Assignment, Course, QuestionOption
...
class SurveyTemplateTest(TestCase):
    ...
    def test_get_sections_property(self):
        ...
        self.assertEqual(survey_template.sections.first().title, "Test Section")
        self.assertEqual(survey_template.sections.first().description, "Test Description")
...
class FeedbackSurveyTest(TestCase):
    ...
    def setUp(self):
        self.course = Course.objects.get(course_number="18652", semester="Fall 2021")
        self.assignment = Assignment.objects.get(assignment_name="Chat Room Iteration 1")
    ...
    def test_get_feedback_survey(self):
        ...
        self.assertEqual(feedback_survey.template.name, self.survey_template.name)
        self.assertEqual(feedback_survey.assignment.assignment_name, self.assignment.assignment_name)
...
class SurveySectionTest(TestCase):
    ...
    def test_get_questions_property(self):
        ...
        self.assertEqual(survey_section.questions.count(), 1)
        self.assertEqual(survey_section.questions.first().text, "Test Question")
        self.assertEqual(survey_section.questions.first().question_type, "MULTIPLECHOICE")
...
class SurveyQuestionTest(TestCase):
    ...
    def test_get_option_choice_property(self):
        ...
        self.assertEqual(survey_question.options.first().option_choice.text, "Test Option")
